                ...
                children: [
                  Text(
                    FFLocalizations.of(context).getText(
                      'mfh4vkem' /* Build Your Ice Cream Business ... */,
                    ),
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      '4uqiyqia' /* Learn the process, understand ... */,
                    ),
                    textAlign: TextAlign.center,
                ...
                children: [
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      FFAppState().hasOption = true;
                      safeSetState(() {});
                    },
                    text: FFLocalizations.of(context).getText(
                      'aiqfher9' /* Start Learning */,
                    ),
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      unawaited(
                        () async {
                          await launchURL('https://wa.me/758097748');
                        }(),
                      );
                    },
                    text: FFLocalizations.of(context).getText(
                      'j1g9mzg7' /* Get Equipment */,
                    ),
                    options: FFButtonOptions(
                      width: double.infinity,
                      height: 48.0,
