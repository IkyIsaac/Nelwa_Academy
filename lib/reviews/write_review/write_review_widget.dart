                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                dateTimeFormat(
                                  "yMMMd",
                                  columnCoursesRecord.publishedDate!,
                                  locale:
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'w9it0rn7' /* How was your course experience... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                                  ...
                                  children: [
                                    TextSpan(
                                      text: FFLocalizations.of(context).getText(
                                        'kaf4vgfr' /* Share your thoughts on “ */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                            ...
                            Padding(
                              ...
                              child: RatingBar.builder(
                                ...
                                itemCount: 5,
                                itemPadding:
                                    EdgeInsets.fromLTRB(0.0, 0.0, 3.0, 0.0),
                                itemSize: 56.0,
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'dok3kwv5' /* Let us know what you think. */,
                                      ),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (_model.ratingBarValue! > 0.0) {
                                    await UserReviewsRecord.createDoc(
                                            currentUserReference!)
                                        .set(createUserReviewsRecordData(
                                      comment: _model.textController.text,
                                      courseTitle: columnCoursesRecord.title,
                                      courseImage: columnCoursesRecord.image,
                                      courseInstructor:
                                          columnCoursesRecord.instructorName,
                                    ...
                                    await CoursesReviewRecord.createDoc(
                                            columnCoursesRecord.reference)
                                        .set(createCoursesReviewRecordData(
                                    ...
                                    await columnCoursesRecord.reference.update({
                                      ...createCoursesRecordData(
                                        rating: ((_model.ratingBarValue!) +
                                                columnCoursesRecord.rating) /
                                            (columnCoursesRecord.reviewsCount +
                                                1),
                                      ),
                                      ...mapToFirestore(
                                        {
                                    ...
                                    await widget.purchasedCoursesDoc!.reference
                                        .update(
                                            createPurchasedCoursesRecordData(
                                      reviwed: true,
                                    ));

                                    await NotificationRecord.createDoc(
                                            columnCoursesRecord.instructorRef!)
