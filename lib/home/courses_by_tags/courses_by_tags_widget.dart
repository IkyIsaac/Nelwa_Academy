...
import 'courses_by_tags_model.dart';
export 'courses_by_tags_model.dart';

class CoursesByTagsWidget extends StatefulWidget {
  const CoursesByTagsWidget({
    super.key,
    required this.tag,
  });
  ...
  static String routeName = 'CoursesByTags';
  static String routePath = '/coursesByTags';

  @override
  State<CoursesByTagsWidget> createState() => _CoursesByTagsWidgetState();
}

class _CoursesByTagsWidgetState extends State<CoursesByTagsWidget> {
  late CoursesByTagsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoursesByTagsModel());
                                      ...
                                      children: List.generate(
                                        ...
                                        return wrapWithModel(
                                          ...
                                          child: SquareCardWidget(
                                            key: Key(
                                              'Keyt5q_${conditionalBuilderVarIndex.toString()}',
                                            ),
                                            coursesDoc:
                                ...
                                itemBuilder: (context, coursesVerticalIndex) {
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: HorizontalCardWidget(
                                      key: Key(
                                        'Key0lp_${coursesVerticalIndex.toString()}',
                                      ),
