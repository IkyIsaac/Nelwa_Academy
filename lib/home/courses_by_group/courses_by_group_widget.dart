...
import 'courses_by_group_model.dart';
export 'courses_by_group_model.dart';

class CoursesByGroupWidget extends StatefulWidget {
  const CoursesByGroupWidget({
    super.key,
    required this.group,
  });
  ...
  static String routeName = 'CoursesByGroup';
  static String routePath = '/coursesByGroup';

  @override
  State<CoursesByGroupWidget> createState() => _CoursesByGroupWidgetState();
}

class _CoursesByGroupWidgetState extends State<CoursesByGroupWidget> {
  late CoursesByGroupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoursesByGroupModel());
                                      ...
                                      children: List.generate(
                                        ...
                                        return wrapWithModel(
                                          ...
                                          child: SquareCardWidget(
                                            key: Key(
                                              'Keymbb_${conditionalBuilderVarIndex.toString()}',
                                            ),
                                            coursesDoc:
                                ...
                                itemBuilder: (context, coursesVerticalIndex) {
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: HorizontalCardWidget(
                                      key: Key(
                                        'Keyp15_${coursesVerticalIndex.toString()}',
                                      ),
