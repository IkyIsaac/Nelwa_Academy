...
import 'courses_by_topics_model.dart';
export 'courses_by_topics_model.dart';

class CoursesByTopicsWidget extends StatefulWidget {
  const CoursesByTopicsWidget({
    super.key,
    required this.topic,
  });
  ...
  static String routeName = 'CoursesByTopics';
  static String routePath = '/coursesByTopics';

  @override
  State<CoursesByTopicsWidget> createState() => _CoursesByTopicsWidgetState();
}

class _CoursesByTopicsWidgetState extends State<CoursesByTopicsWidget> {
  late CoursesByTopicsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoursesByTopicsModel());
                                      ...
                                      children: List.generate(
                                        ...
                                        return wrapWithModel(
                                          ...
                                          child: SquareCardWidget(
                                            key: Key(
                                              'Key402_${conditionalBuilderVarIndex.toString()}',
                                            ),
                                            coursesDoc:
                                ...
                                itemBuilder: (context, coursesVerticalIndex) {
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: HorizontalCardWidget(
                                      key: Key(
                                        'Key9us_${coursesVerticalIndex.toString()}',
                                      ),
