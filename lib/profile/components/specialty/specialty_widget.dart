...
class _SpecialtyWidgetState extends State<SpecialtyWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpecialtyModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.selectedSpecialty =
          valueOrDefault(currentUserDocument?.specialty, '');
      safeSetState(() {});
    });
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final specialty = containerOptionsRecord
                                                ?.specialty
                                                .toList() ??
                                            [];
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          FFAppState().specialty = _model.selectedSpecialty!;
                          FFAppState().update(() {});
                          Navigator.pop(context);
                        },
