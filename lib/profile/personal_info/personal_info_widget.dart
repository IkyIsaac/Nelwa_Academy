...
import '/profile/components/specialty/specialty_widget.dart';
...
class _PersonalInfoWidgetState extends State<PersonalInfoWidget> {
  ...
  void initState() {
    ...
    _model.aboutTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.aboutUser, ''));
    ...
    _model.phoneNumberMask = MaskTextInputFormatter(mask: '+1 (###) ###-####');
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() =>
                                          _model.isDataUploading_uploadDataY7m =
                                              true);
                                      ...
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_uploadDataY7m =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_uploadDataY7m =
                                              downloadUrls.first;
                                        });
                                      } else {
                                        safeSetState(() {});
                                          ...
                                          builder: (context) => Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                ...
                                                image: Image.network(
                                                  () {
                                                    if (_model.uploadedFileUrl_uploadDataY7m !=
                                                            '') {
                                                      return _model
                                                          .uploadedFileUrl_uploadDataY7m;
                                ...
                                builder: (context) => Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'wg36599e' /* Tell us a little about yoursel... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                      ...
                                      Padding(
                                        ...
                                        child: AuthUserStreamWidget(
                                          builder: (context) => Text(
                                            () {
                                              if (FFAppState().specialty !=
                                                      '') {
                                                return FFAppState().specialty;
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    await currentUserReference!.update(createUsersRecordData(
                      ...
                      aboutUser: _model.aboutTextController.text,
                      country: FFAppState().country.country,
                      specialty: FFAppState().specialty,
                    ));
                    await Future.wait([
                      Future(() async {
                        if (_model.datePicked != null) {
                      ...
                      Future(() async {
                        if (_model.uploadedFileUrl_uploadDataY7m != '') {
                          await currentUserReference!
                              .update(createUsersRecordData(
                            photoUrl: _model.uploadedFileUrl_uploadDataY7m,
                          ));
                        }
                      }),
                      Future(() async {
