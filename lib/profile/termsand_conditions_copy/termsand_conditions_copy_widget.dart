...
import 'termsand_conditions_copy_model.dart';
export 'termsand_conditions_copy_model.dart';

class TermsandConditionsCopyWidget extends StatefulWidget {
  const TermsandConditionsCopyWidget({super.key});

  static String routeName = 'TermsandConditionsCopy';
  static String routePath = '/termsandConditionsCopy';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    'p3ikwswu' /* Welcome to SkillBase! By using... */,
                  ),
