...
import 'instructor_courses_model.dart';
export 'instructor_courses_model.dart';

class InstructorCoursesWidget extends StatefulWidget {
  const InstructorCoursesWidget({
    super.key,
  ...
  static String routeName = 'InstructorCourses';
  static String routePath = '/instructorCourses';

  @override
  State<InstructorCoursesWidget> createState() =>
      _InstructorCoursesWidgetState();
}

class _InstructorCoursesWidgetState extends State<InstructorCoursesWidget> {
  late InstructorCoursesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InstructorCoursesModel());
              ...
              child: StreamBuilder<List<CoursesRecord>>(
                stream: queryCoursesRecord(
                  queryBuilder: (coursesRecord) => coursesRecord.where(
                    'instructor_ref',
                    isEqualTo: widget.instructorRef,
                  ),
                ),
                                      ...
                                      children: List.generate(
                                        ...
                                        return wrapWithModel(
                                          ...
                                          child: SquareCardWidget(
                                            key: Key(
                                              'Keyaub_${conditionalBuilderVarIndex.toString()}',
                                            ),
                                            coursesDoc:
                                ...
                                itemBuilder: (context, coursesVerticalIndex) {
                                  ...
                                  return wrapWithModel(
                                    ...
                                    child: HorizontalCardWidget(
                                      key: Key(
                                        'Keymoh_${coursesVerticalIndex.toString()}',
                                      ),
