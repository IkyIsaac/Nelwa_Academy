...
import 'courses_page_copy_model.dart';
export 'courses_page_copy_model.dart';

class CoursesPageCopyWidget extends StatefulWidget {
  const CoursesPageCopyWidget({
    super.key,
  ...
  static String routeName = 'CoursesPageCopy';
  static String routePath = '/coursesPageCopy';

  @override
  State<CoursesPageCopyWidget> createState() => _CoursesPageCopyWidgetState();
}

class _CoursesPageCopyWidgetState extends State<CoursesPageCopyWidget> {
  late CoursesPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoursesPageCopyModel());
          ...
          child: Column(
            ...
            children: [
                  ...
                  if (_model.showVideo) {
                    return FlutterFlowVideoPlayer(
                      path: valueOrDefault<String>(
                        widget.coursesDoc?.videoPreview,
                        'https://firebasestorage.googleapis.com/v0/b/nelwasacademy-7uw9xf.firebasestorage.app/o/users%2Fcaoxh1arH6YNTEwwY9YnOt0VwKE2%2Fuploads%2F1766222111358000.mp4?alt=media&token=a61bf61b-f7e7-4814-a104-dc46f94dbf5f',
                      ),
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              widget.coursesDoc?.previewViews
                                                  .length
                                                  .toString(),
                                              '0',
                                            ),
                          ...
                          StreamBuilder<List<InstructorDetailsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final buttonInstructorDetailsRecord =
                                  buttonInstructorDetailsRecordList.isNotEmpty
                                      ? buttonInstructorDetailsRecordList.first
                                      : null;

                              return FFButtonWidget(
                                onPressed: () async {
                                  if (buttonInstructorDetailsRecord.followers
              ...
              Padding(
                ...
                child: Builder(
                  builder: (context) {
                    final tagsList = widget.coursesDoc?.tags.toList() ?? [];
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      valueOrDefault<String>(
                        widget.coursesDoc?.downloaders.length.toString(),
                        '0',
                      ),
                      style: FlutterFlowTheme.of(context).titleSmall.override(
                            font: GoogleFonts.inter(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: _model.moreDescription ? 'Hide' : 'Read more',
                        style: TextStyle(
                          color: FlutterFlowTheme.of(context).primary,
                        ),
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (listViewLessonsRecordList.isEmpty) {
                      return EmptyLessonsWidget(
                        instructorRef: widget.coursesDoc!.instructorRef!,
                      );
                    }
                          ...
                          builder: (context) {
                            if (widget.coursesDoc?.instructorRef ==
                              ...
                              return InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  if (listViewLessonsRecord.isFree == true) {
                                    context.pushNamed(
                                      LessonPageWidget.routeName,
                                      queryParameters: {
