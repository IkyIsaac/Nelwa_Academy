...
import '/courses/components/add_new_category/add_new_category_widget.dart';
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child: AddNewCategoryWidget(
                                        options: containerOptionsRecord!,
                                      ),
                                    );
                                  },
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final categories =
                                              containerOptionsRecord?.categories
                                                      .toList() ??
                                                  [];
