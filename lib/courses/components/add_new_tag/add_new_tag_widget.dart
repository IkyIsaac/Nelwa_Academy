...
class AddNewTagWidget extends StatefulWidget {
  const AddNewTagWidget({
    super.key,
    required this.optionsDoc,
  });

  final OptionsRecord? optionsDoc;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    _model.error!
                        ? 'This tag is already available in the system'
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  if (_model.categoryNameTextController.text != '') {
                    if (widget.optionsDoc!.courseAudience
                        .contains(_model.categoryNameTextController.text)) {
                      _model.error = true;
                      safeSetState(() {});
                    } else {
                      await currentUserReference!.update({
                        ...mapToFirestore(
                          {
                            'custom_tags': FieldValue.arrayUnion(
                                [_model.categoryNameTextController.text]),
                          },
                        ),
                      });

                      await widget.optionsDoc!.reference.update({
                        ...mapToFirestore(
                          {
